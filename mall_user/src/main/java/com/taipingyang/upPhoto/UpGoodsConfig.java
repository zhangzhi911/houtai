...
public class UpGoodsConfig {
    ...
    public Map<String, Object> update(User user, @RequestParam(required = false, name = "photoo") MultipartFile photo) throws IOException {
        FileInfoo fileInfoo = upload(photo);
        user.setPhoto(fileInfoo.getPath());
